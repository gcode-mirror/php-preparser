Welcome to the Preparser 0.1 Release! 

RELEASE INFORMATION
---------------
Preparser 0.1dev Release ([INSERT REV NUM HERE]).
Released on <Month> <Day>, <Year>.

SYSTEM REQUIREMENTS
-------------------

Preparser requires PHP 5.3 or later.
...
The files in this archive are released under the Preparser license.
